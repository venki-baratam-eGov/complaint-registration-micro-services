...
import org.location.transform.ComplaintDeserializer;
...
@Configuration
@EnableKafka
public class ComplaintValidatedConsumerConfig {
	...
	public Map<String, Object> consumerConfigs() {
		...
		propsMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ComplaintDeserializer.class);
		return propsMap;
	}

	@Bean
	public ComplaintValidatedConsumer listener() {
		return new ComplaintValidatedConsumer();
	}
