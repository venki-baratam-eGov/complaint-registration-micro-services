...
import org.employee.transform.ComplaintDeserializer;
...
@Configuration
@EnableKafka
public class LocationPopulatedConsumerConfig {
	...
	@Bean
	public LocationPopulatedConsumer listener() {
		return new LocationPopulatedConsumer();
	}
