...
import org.complaint.transform.ComplaintDeserializer;
...
@Configuration
@EnableKafka
public class EmployeePopulatedConsumerConfig {
	...
	@Bean
	public EmployeePopulatedConsumer listener() {
		return new EmployeePopulatedConsumer();
	}
