...
public class Complainant extends AbstractPersistable<Long> {
	...
	public Complainant(org.complaint.web.contract.Complainant contractComplainant) {
		this.setName(contractComplainant.getName());
		this.setMobile(contractComplainant.getMobile());
		this.setEmail(contractComplainant.getEmail());
		this.setAddress(contractComplainant.getAddress());
	}
