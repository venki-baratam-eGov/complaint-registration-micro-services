...
public class ComplaintController {
	...
	public ResponseEntity<?> create(@RequestBody Complaint complaint, BindingResult bindingResult) {
		...
		return getSuccessResponseForCreate(complaintService.push(complaint));
	}

	@PostMapping("/{id}/_update")

	@ResponseBody
	public ResponseEntity<?> update(@RequestBody org.complaint.persistence.complaint.entity.Complaint complaint,
		...
		if (errorResponseEntity != null)
			return errorResponseEntity;
		complaint.setId(id);
		return getSuccessResponseForUpdate(complaintService.update(complaint));
	}
